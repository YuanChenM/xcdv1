...
function getMarketInfoStr(terMarketId,marketName){
    ...
    str = str + "<div class='ui-block-b' style='width: 20%;' ><div id='"+terMarketId+"_2' onclick='marketTerminalEdit(this)' style='margin-left:0px;text-align: center;' class='listDiv'>编辑</div></div>";
    str = str + "</div>";
    return str;
}
//返回前一个画面
