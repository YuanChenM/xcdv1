...
$(function () {
    ...
    // 获取买家经营产品类别选项
    var flickerAPI = url + 'api/v1/by/common/pdClass';
    ...
    // 获取买家经营产品二级类别选项
    var flickerAPI = url + 'api/v1/by/common/pdMachining';
    var paramData = {"client": "abcd", "auth": "xxxx", "loginid": "a124", "param": {}};
    $.ajax({
        type: "POST",
        async: false,
    ...
    // 获取买家收货地址
    var flickerAPI = url + 'api/v1/by/receiveAddr/findList';
    ...
    // 获取买家收货时间段
    var receiveTime = [];
    var flickerAPI = url + 'api/v1/by/receiveTime/findList';
    var paramData = {"client": "abcd", "auth": "xxxx", "loginid": "a124", "param": {"buyerId": localStorage.buyerId}};
    $.ajax({
        type: "POST",
        async: false,
    ...
    // 获取买家销售对象
    var salesTarget = [];
    var flickerAPI = url + 'api/v1/by/salesTarget/findList';
    var paramData = {"client": "abcd", "auth": "xxxx", "loginid": "a124", "param": {"buyerId": localStorage.buyerId}};
    $.ajax({
        type: "POST",
        async: false,
    ...
    // 获取买家产品类别
    var pdClasses = [];
    var flickerAPI = url + 'api/v1/by/pdClassification/findList';
    var paramData = {"client": "abcd", "auth": "xxxx", "loginid": "a124", "param": {"buyerId": localStorage.buyerId}};
    $.ajax({
        type: "POST",
        async: false,
...
//获取选择的收货时间并更新数据库
    ...
    if (countRecSelected == receiveTimeCommon.length) {
        ...
        //更新买家收货时间
        var flickerAPI = url + 'api/v1/by/receiveTime/update';
    ...
    if (countTargetSelected == salesTargetCommon.length) {
        ...
        //更新买家销售对象
        var flickerAPI = url + 'api/v1/by/salesTarget/update';
    ...
    if (countClaSelected == pdClassesCommon.length) {
        ...
        var flickerAPI = url + 'api/v1/by/pdClassification/update';
...
function receiveAddrSave() {
    ...
    if ($("#enterFlag").val() == "modify") {
        flickerAPI = url + 'api/v1/by/receiveAddr/update';
        paramData = {
            "client": "abcd",
            "auth": "xxxx",
            "loginid": "a124",
        ...
        flickerAPI = url + 'api/v1/by/receiveAddr/phoneSave';
        paramData = {
            "client": "abcd",
            "auth": "xxxx",
            "loginid": "a124",
