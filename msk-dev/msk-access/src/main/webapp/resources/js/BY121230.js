$(function(){
    ...
    // 显示买家的详细信息
    var flickerAPI = url+'api/v1/by/condition/findMarketTerminal';
...
function getLogsArea(lgcsAreaCode){
    var flickerAPI = url+'api/v1/md/getLogisticsAreas';
    ...
    $.ajax({
        ...
        data:JSON.stringify(paramData),
        success:function(data){
            var areas = data.result.logisticsAreas;
...
function getCity(lgcsAreaCode,cityCode){
    var flickerAPI = url+'api/v1/md/getCitys';
    var paramData = {"client": "abcd","auth": "xxxx","loginid": "a124","param": {"prLgcsType":1,"prLgcsCode":lgcsAreaCode}};
    $.ajax({
        type : "POST",
        async:false,
        url:flickerAPI,
...
function getDistrict(cityCode,districtCode){
    var flickerAPI = url+'api/v1/md/getDistricts';
...
function byMarketTerminalUpdate(){
    var flickerAPI = url + 'api/v1/by/byMarketTerminal/update';
    var terMarketId = localStorage.terMarketId;
