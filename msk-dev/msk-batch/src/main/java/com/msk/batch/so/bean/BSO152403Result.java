...
public class BSO152403Result extends BaseEntity {
    /** 发货单号 */
    private Long shipId;
    /** 发货单编码 */
    ...
    /** ReceiverInfo */
    private BSO152403ReceiverInfo receiver;
    /**产品信息*/
    private List<BSO152403DetailResult> productDetailList;
    /** 订单号 */
    ...
    public BSO152403ReceiverInfo getReceiver() {
        return receiver;
    }

    public void setReceiver(BSO152403ReceiverInfo receiver) {
        this.receiver = receiver;
    }
    @XmlElementWrapper(name="LINES")
    @XmlElement(name="LINE")
    public List<BSO152403DetailResult> getProductDetailList() {
        return productDetailList;
    }

    public void setProductDetailList(List<BSO152403DetailResult> productDetailList) {
