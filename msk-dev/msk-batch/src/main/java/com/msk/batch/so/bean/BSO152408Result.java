...
@XmlType(propOrder = {"shipId","shipCode","orderType","buyersId","buyersType","buyersName","strForecastReceiveTime","strForecastSendTime","whCode","whName","ver","paymentType","receiver","productDetailList"})
public class BSO152408Result extends BaseEntity {
    /** 发货单号 */
    private Long shipId;
    /** 发货单编码 */
    ...
    /** ReceiverInfo */
    private BSO152408ReceiverInfo receiver;
    /**产品信息*/
    private List<BSO152408DetailResult> productDetailList;
    /** 订单号 */
    ...
    public BSO152408ReceiverInfo getReceiver() {
        return receiver;
    }

    public void setReceiver(BSO152408ReceiverInfo receiver) {
        this.receiver = receiver;
    }
    @XmlElementWrapper(name="LINES")
    @XmlElement(name="LINE")
    public List<BSO152408DetailResult> getProductDetailList() {
        return productDetailList;
    }

    public void setProductDetailList(List<BSO152408DetailResult> productDetailList) {
    ...
    @XmlElement(name = "WHNAME",defaultValue = "")
    ...
    @XmlElement(name = "WHCODE",defaultValue = "")
