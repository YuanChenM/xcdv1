...
/**
 * <p>表sl_bs_basic_info对应的SlBsBasicInfo。</p>
 *
 * @author 自动生成
 * @version 1.00
 */
public class SlBsBasicInfo extends BaseEntity {
    /**
     * 
     */
     ...
     * @param hkSeq 01,02。
     */
    public void setHkSeq(String hkSeq) {
        this.hkSeq = hkSeq;
    }
