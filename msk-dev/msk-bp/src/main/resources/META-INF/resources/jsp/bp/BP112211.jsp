...
<navigation:header title="云冻品B2B卖家产品库存一览" backTitleArray="" backUrlArray=""></navigation:header>

<div class="page-content list-page">
    <form action="${ctx}/BP112211/search" id="BP112211Form" method="post">
        ...
        <div class="group-accordion" collapsible="true" active="true">
            ...
            <table WIDTH="100%">
                <tr>
                    ...
                    <td align="left"><msk:button buttonValue="查询" buttonId="BP112211.SEARCH" buttonType="button"/>
                </tr>
            </table>
        </div>
...
<script src="${ctx}/js/bp/BP112211.js"></script>
