            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="10px">
                <tr>
                    ...
                    <td align="left" width="">
                        ...
                        <input type="hidden" id="slCode" name="slCode" value="${slShopInfo.slCode}"/>
                    </td>
                </tr>
                    <%--  <tr>
                          <c:if test="${flagNum =='1'}">
                ...
                <tr>
                    ...
                    <td align="left" width="">
                        <input style="width:200px;" type="text" id="managingCharact1" name="managingCharact1"
                               value="${slShopInfo.managingCharact1}" onblur=""/>
                    </td>
                </tr>
                <tr>
                    <td align="right" width="">经营特色2　</td>
                    <td align="left" width="">
                        <input style="width:200px;" type="text" id="managingCharact2" name="managingCharact2"
                               value="${slShopInfo.managingCharact2}" onblur=""/>
                    </td>
                </tr>
                <tr>
                    <td align="right" width="">经营特色3　</td>
                    <td align="left" width="">
                        <input style="width:200px;" type="text" id="managingCharact3" name="managingCharact3"
                               value="${slShopInfo.managingCharact3}" onblur=""/>
                    </td>
                </tr>
                <tr>
                    <td></td>
...
<script src="${ctx}/js/bs/BS2101110.js"></script>
