...
public class BY121307Bean extends BaseEntity {
    ...
    /** 买家证照信息*/
    private ByBuyerLicence buyerLicence;
    /** 买家收货地址信息*/
     ...
     */
    public ByBuyerLicence getBuyerLicence() {
        return buyerLicence;
    }

    /**
     * Setter method for property <tt>buyerLicence</tt>.
     *
     * @param buyerLicence value to be assigned to property buyerLicence
     */
    public void setBuyerLicence(ByBuyerLicence buyerLicence) {
