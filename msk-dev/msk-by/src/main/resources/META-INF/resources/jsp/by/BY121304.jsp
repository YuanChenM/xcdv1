...
<navigation:header title="买家详细信息" backTitleArray="买家列表" backUrlArray="${ctx}/BY121303/init/"></navigation:header>
...
<script type="text/javascript" src="${ctx}/js/by/BY121304.js"></script>