                    ...
                    <c:forEach items="${pdClaShowList}" var="pdClaShow">
                        <c:choose>
                            <c:when test="${pdClaShow.isChecked eq '1'}">
                                <input type="checkbox" name="selectPdCla" value="${pdClaShow.classCode}" checked/>${pdClaShow.className}
                            </c:when>
                            <c:otherwise>
                                <input type="checkbox" name="selectPdCla" value="${pdClaShow.classCode}"/>${pdClaShow.className}
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                </td>
...
<script type="text/javascript" src="${ctx}/js/by/comm/BASE_BUYER_REC_INFO.js"></script>
