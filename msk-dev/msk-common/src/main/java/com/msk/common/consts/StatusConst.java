...
public final class StatusConst {
    ...
    public final static class OrderDetailStatusDef{
        ...
        /** 待审核*/
        public final static int PENDING_AUDIT = 8;
        /** CANCEL:取消 */
        public final static int CANCEL = 99;
    }
    ...
    public final static class ReturnOrderStatusDef {
        ...
        /** RECEIVER_LATER:迟收  迟收成功*/
        public final static int RECEIVER_LATER = 9;
        /** CANCEL:取消退货单  已取消*/
        public final static int CANCEL = 99;
    }
    ...
    public final static class OrderShipStatusDef{
        ...
        public final static int ALL_RETURN = 7;
        /** WAIT_WH:待分配仓库 */
        public final static int WAIT_WH = 8;
        /** WAIT_WMS:待传递WMS */
        public final static int WAIT_WMS = 9;
        /** WAIT_CANCEL:待取消 */
     ...
     * 投訴状态
     */
    public final static class OrderComplainStatusDef {
        public final static String TYPE = "OrderComplainStatus";
        /** COMPLAINING:投诉中 */
        public final static int COMPLAINING = 1;
        /** PROCESS:平台处理中 */
