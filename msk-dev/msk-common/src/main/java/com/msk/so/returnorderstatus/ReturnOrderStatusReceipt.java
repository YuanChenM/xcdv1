 ...
 * @version 1.0
 **/
public class ReturnOrderStatusReceipt extends BaseReturnOrderStatus{
    /**
     * logger
     */
    private static Logger logger = LoggerFactory.getLogger(ReturnOrderStatusReceipt.class);
    //更新退货单主表状态logic
    private ReturnStatusLogic returnStatusLogic;
    
    public ReturnOrderStatusReceipt(ReturnOrderStatusLogic returnOrderStatusLogic, ReturnOrderStatusParam returnOrderStatusParam) {
