...
public class BaseUploadController extends BaseController {
    ...
    public void saveFile(MultipartFile file, String basePatch, String newFileName)
     ...
     * @throws java.io.IOException
     */
    public String saveFileSystemTime(MultipartFile file, String basePatch, String dateFormat)
        throws IllegalStateException, IOException {
        if (null == file || file.getSize() == 0L) {
            return null;
        }
