...
public interface BusinessConst {
    ...
    final class BuyerType {
        ...
        //默认买家编码最后两位校验码
        public final static String CheckOutCode = "00";

        //是否菜场买家 1：是菜场买家，0：非菜场买家
        public final static String isMarket = "1";

        //识别码
        public final static String IdentCode = "99";
     ...
     * 结算详情状态
     */
    final class SettlementDetailStatus {
        public final static String Type = "SettlementDetailStatus";
        /** 全部 */
        public final static String AllStatus = "0";
        /** 交易成功 */
        public final static String TradeSuccess = "1";
        /** 退款成功 */
        public final static String RefundSuccess = "2";
