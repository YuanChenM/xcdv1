...
public class BaseDao extends SqlSessionDaoSupport {
     ...
     * @return List数据集
     */
    public <T extends BaseEntity> List<T> selectList(String sqlId, BaseParam param) {
     ...
     * @return List数据集合
     */
    public <T extends BaseEntity> List<T> selectList(String sqlId, Map<String, Object> param) {
        return this.getSqlSession().selectList(sqlId, param);
    }
     ...
     * @return Entity对象
     */
    public <T extends BaseEntity> T selectOne(String sqlId, BaseParam param) {
     ...
     * @return Entity对象
     */
    public <T extends BaseEntity> T selectOne(String sqlId, BaseEntity param) {
        return this.getSqlSession().selectOne(sqlId, param);
    }
     ...
     * @return Entity对象
     */
    public <T extends BaseEntity> T selectOne(String sqlId, Map<String, Object> param) {
        return this.getSqlSession().selectOne(sqlId, param);
    }
     ...
     * @return Count
     */
    public int count(String sqlId, BaseEntity param) {
        Integer count = this.getSqlSession().selectOne(sqlId, param);
        return count == null ? 0 : count;
    }
     ...
     * @return 插入返回的行数
     */
    public <T extends BaseEntity> int insert(String sqlId, T entity) {
     ...
     * @return 插入返回的行数
     */
    public <T extends BaseEntity> int batchInsert(String sqlId, List<T> entityList) {
     ...
     * @return 删除影响的行数
     */
    public <T extends BaseEntity> int delete(String sqlId, T entity) {
        return this.getSqlSession().update(sqlId, entity);
    }
