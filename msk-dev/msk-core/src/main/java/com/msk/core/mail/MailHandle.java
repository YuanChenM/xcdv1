...
public final class MailHandle {
     ...
     * @author Administrator
     */
    public static void sendSimpleEmail(String title, String context, String[] emails,String...emailCCs) {
        ...
        try {
            ...
            mail.send();
            logger.info("发送Simple邮件成功");
        } catch (EmailException e) {
            throw new SystemException("发送Simple邮件失败", e);
        }
    }
    ...
    public static void sendMultiPartEmail(String title, String context, File[] fileList, String[] emailCCs,
        ...
        try {
            ...
            throw new SystemException("发送附件邮件失败", e);
        }
    }
     ...
     * @param emails 收信人列表
     */
    public static void sendHtmlEmail(String title, String htmlcontext, String[] emails,String...emailCCs) {
        logger.info("发送HTML格式邮件");
        MailFactory mailFactory = new MailFactory();
        try {
            Email mail = mailFactory.createHtmlEmail();
            setToMailParam(mail, title, htmlcontext,emailCCs, emails);
            mail.send();
            logger.info("发送HTML格式邮件成功");
        } catch (EmailException e) {
            throw new SystemException("发送HTML格式邮件失败", e);
        }
    }
