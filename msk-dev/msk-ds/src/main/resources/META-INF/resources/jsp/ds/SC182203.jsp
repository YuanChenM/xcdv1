...
<navigation:header title="产品批次查询" backTitleArray=" " backUrlArray=" "></navigation:header>
    ...
    <form action="${ctx}/SC182203/search" method="post">
        <table id="SC182203_Grid">
            ...
            <tr>
                ...
                <th coltype="select" width="" name="lgcsName" filter="true">銷售区域
                    <select>
...
<script src="${ctx}/js/ds/SC182203.js"></script>