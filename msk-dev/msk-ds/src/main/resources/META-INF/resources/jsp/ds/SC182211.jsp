...
<navigation:header title="批次数据打印" backTitleArray="" backUrlArray=""></navigation:header>
        ...
        <form:form action="${ctx}/SC182211/init" id="SC182211Form" method="post">
            ...
            <table>
                    ...
                    <td align="left">
                        <select style="width: 138px;" id="lgcsCode" name="lgcsCode">
                            ...
                            <c:forEach items="${lgcsCodeList}" var="lgcsList">
                                <option value="${lgcsList.lgcsCode}" valuetwo="${lgcsList.lgcsName}">${lgcsList.lgcsName}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="left" style="color:red">时间</td>
                    <td align="left">
...
<script type="text/javascript" src="${ctx}/js/ds/SC182211.js"></script>
