...
<navigation:header title="卖家产品实际录入历史一览" backTitleArray=" " backUrlArray=" "></navigation:header>
    ...
    <form action="${ctx}/SC183104/search" method="post">
        <table id="SC183104_Grid">
            ...
            <tr>
                ...
                <th coltype="text"  name="inputDate" filter="true">录入日期</th>
                <th coltype="text"  name="oldActualNum" filter="true">原实际数量</th>
                <th coltype="text"  name="newActualNum" filter="true">新实际数量</th>
...
<script src="${ctx}/js/ds/SC183104.js"></script>
