    ...
    <form action="${ctx}/TSC20033/search" method="post">
        <table id="TSC20033_grid" showAddBtn="true" class="tree dataTable no-footer" width="auto">
            ...
            <tr style="background:#DBDBDB">
                ...
                <td align="center" width="40px"></td>
                <td align="center" width="40px">1500</td>
...
<div class="group-accordion" collapsible="false" active="false" id="TSC20033accordion">
    <h3 style="position: relative">
        <label>仓库确认</label>
    </h3>
    <form action="${ctx}/TSC20033/search" method="post">
        <div align="center">
        <p>确认通过：<input type="radio" name="aa" checked="checked"/>  未通过：<input type="radio" name="aa"/></p>
            理由描述：<textarea cols="20" rows="6">仓库有空余空位，同意入库</textarea>
        <p><msk:button buttonValue="保存" buttonId="TSC20033.SAVE" buttonType="button"/></p>
        </div>
    </form>
</div>
<div class="group-accordion" collapsible="false" active="false">
    ...
    <form action="${ctx}/TSC20033/search" method="post">
        <div align="center">
            <p>确认通过：<input type="radio" name="bb" checked="checked"/>  未通过：<input type="radio" name="bb"/></p>
            理由描述：<textarea cols="20" rows="6">生产完成，随时可以发货</textarea>
            <p><msk:button buttonValue="保存" buttonId="TSC20033.SAVE2" buttonType="button"/></p>
        </div>
    </form>
</div>
<div class="group-accordion" collapsible="false" active="false">
    ...
    <form action="${ctx}/TSC20033/search" method="post">
        <div align="center">
            <p><msk:button buttonValue="生成发货单" buttonId="TSC20033.SAVE3" buttonType="button"/></p>
        </div>
    </form>
</div>
