...
<navigation:header title="生产商发货差异单管理" backTitleArray=" " backUrlArray=" "></navigation:header>
<%--<div class="group-accordion" collapsible="false" active="false" id="TSC20051accordion"
     style=" width:auto;overflow:auto; ">--%>

    <form action="${ctx}/TSC20051/search" method="post">
        <table id="TSC20051_list_grid" showAddBtn="true">
            <thead>
            <tr>
...
<script src="${ctx}/js/ds/TSC20051.js"></script>
