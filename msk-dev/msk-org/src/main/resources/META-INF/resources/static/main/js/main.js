			...
			$("#main-content").postUrl(Main.contextPath +"/favorites/save",
				...
				function(result){
					if(result=="HAS") {
						...
						+ pageUrl
						+ '" target="ajax" rel="main-content"><span style="background: url( '+ Main.contextPath + '/static/core/images/action/lost.png) no-repeat center;"></span>'
						+ pageName + '</a><span><img style="margin-left: 3px;margin-top: -2px;" src="' + Main.contextPath + '/static/main/images/action/close.png" alt="删除"></span></li>');
