...
public class IPD141140RsBean extends BaseEntity {
    ...
    private String localName; // 俗名
    private String salesName; // 销售名
    private String placeOrigin; // 原料原产地
    private String placeCurrent; // 现产地
    private String source; // 原料种源
    private String childType; // 雏类
    private String feedType; // 饲养方式
    private String feedPeriod; // 饲养周期
