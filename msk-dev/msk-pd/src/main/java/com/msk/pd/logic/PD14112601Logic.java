...
public class PD14112601Logic extends BaseLogic {
     ...
     * @return
     */
    public int deleteData(String deleteValue) {
        BaseParam param = new BaseParam();
     ...
     * @return
     */
    public int updateData(String updateValue) {
        BaseParam param = new BaseParam();
     ...
     * @return
     */
    public int deleteProvider(String tcProviderId) {
        BaseParam param = new BaseParam();
     ...
     * @return
     */
    public int updateProvider(String tcProviderId) {
        BaseParam param = new BaseParam();
        param.setFilter("tcProviderId", tcProviderId);
        param.setFilter("featureFlg", "1");
     ...
     * @return
     */
    public int deleteOnLine(String tcOnlineId) {
        BaseParam param = new BaseParam();
...
/*        param.setFilter("breedCode", code);
     ...
     * @return
     */
    public int deleteProviderContent(String tcContentId) {
        BaseParam param = new BaseParam();
     ...
     * @return
     */
    public int deleteOnlineOem(String tcOemId) {
        BaseParam param = new BaseParam();
     ...
     * @return
     */
    public int deleteTcForbid(String tcForbidId) {
        BaseParam param = new BaseParam();
