            ...
            <thead>
                <tr>
                    ...
                    <th coltype="action">
                         ...
                         <input type="hidden"coltype="check" title="质量标准" class="h-button" />
                         <input type="hidden"coltype="edit" title="技术标准" class="h-button" />
                    </th>
                </tr>
            </thead>
            <tbody>
...
<script type="text/javascript" src="${ctx}/js/pd/PD141113.js" ></script>