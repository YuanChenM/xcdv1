...
<div class="page-content list-page">
        ...
        <table id="PD141115_Grid">
            <thead>
                <tr>
                    ...
                    <th coltype="action">
                         <input type="button" hidden="true" id="closeBtn" coltype="check" title="录入质量标准" class="h-button" />
                         <input type="button" hidden="true" id="deleteBtn" coltype="edit" title="录入技术标准" class="h-button" />
                    </th>
                </tr>
            </thead>
            <tbody>
    ...
    <div>
        <c:if test="${not empty param.breedCode and not empty param.classesCode}">
            <msk:button buttonValue="新建质量信息" buttonId="PD141115.PD141106" url=""/>
            <msk:button buttonValue="新建技术信息" buttonId="PD141115.PD141108" url=""/>
        </c:if>
    
    </div>
</div>
<script type="text/javascript" src="${ctx}/js/pd/PD141115.js"></script>