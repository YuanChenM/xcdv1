...
<script>
	var PD14113601MainPath = '<c:url value="/"/>';
</script>
<div class="group-accordion" collapsible="false" active="false" id="pd14113601accordion" style="height:80%">
    ...
    <form action='<c:url value="/PD14113601/search"/>' method="post">
        ...
        <table id="pd14113601_grid" showAddBtn="true">
            ...
            <tr>
                ...
                <th coltype="action">
                    <input type="button" id="editBtn" hidden="true" title="详细信息" coltype="detail"
                           class="h-button"/>
                </th>
            </tr>
            </thead>
...
<script src="<c:url value="/static/pd/js/PD14113601.js" /> "></script>
