...
var PD14112407 = {
	...
	validateMachining:function(flag){
		...
		if(machiningSel == '' && classestreeName2 == ''){
	...
	validateFeature:function(flag){
		...
		if(featureSel == '' && classestreeName4 == ''){
	...
	saveData : function() {
		...
		if($('.codeName').is(':checked') || $('.onlyName').is(':checked')) {
			if(this.validateNorms()){
				formData.saveType = 6;
				if ('' != machiningSel){
					formData.classestreeCode2 = machiningSel;
					formData.classestreeName2 = $("#machiningSel").find("option:selected").text();
				}else{
					formData.classestreeName2 = classestreeName2;
				}
				if('' != breedSel){
					formData.classestreeCode3 = breedSel;
					formData.classestreeName3 = $("#breedSel").find("option:selected").text();
				}else{
					formData.classestreeName3 = classestreeName3;
				}
				if('' != featureSel){
					formData.classestreeCode4 = featureSel;
					formData.classestreeName4 = $("#featureSel").find("option:selected").text();
				}else{
					formData.classestreeName4 = classestreeName4;
				}
				if('0' != selectWeight){
					formData.classestreeCode5 = selectWeight;
					formData.classestreeName5 = $("#selectWeight").find("option:selected").text();
				}else{
					formData.classestreeName5 = isNull;
				}
			}
		}
		else if ($('.selectWeight').is(':checked') || $('.classestreeName5').is(':checked') || $('.copyCode').is(':checked')) {
		...
		//特征
		else if($('.featureSel').is(':checked') || $('.classestreeName4').is(':checked')){
		...
		//品种
		else if($('.breedSel').is(':checked') || $('.classestreeName3').is(':checked')){
		...
		//二级分类
		else if($('.machiningSel').is(':checked') || $('.classestreeName2').is(':checked')){
	...
	selectChange:function(){
		$("#classesSel").change(function(){
			...
			$(".breedSel").removeAttr("checked");
			$(".classestreeName3").removeAttr("checked");
			$(".machiningSel").removeAttr("checked");
			$("#breedSel").prop("disabled", 'disabled');
			$("#classestreeName3").prop("disabled", 'disabled');
			$("#classestreeName3").val("");
			$(".featureSel").removeAttr("checked");
