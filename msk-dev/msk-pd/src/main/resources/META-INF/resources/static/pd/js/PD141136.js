...
var PD141136 = {
    ...
    init: function () {
        this.linkage();
        this.searchData();
        $("#PD14113601Id").postUrl(mainPath+ "/PD14113601/init");
    },
    linkage: function () {
        $("#classes").change(function () {
            ...
            $('#main-content').postUrl(mainPath + "/PD141136/query", {classesCode: classesCode}, function (data) {
                if (data.length <= 0) {
        ...
        $("#machining").change(function () {
            ...
            $('#main-content').postUrl(mainPath + "/PD141136/query", {
                classesCode: classes,
