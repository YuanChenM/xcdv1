...
/**
 * <p>表pl_declare_info对应的实体PlDeclareInfo</p>
 *
 * @author 自动生成
 * @version 1.0.0
 */
public class PlDeclareInfo extends BaseBean {
    /** 任务详细ID */
    ...
    /** 申报价格 */
    private java.math.BigDecimal declarePrice;
    /** 申报价格对应价盘通道 */
     ...
     * <p>小包装件数（大包装个数）</p>
     *
     * @param smallPackNumber 小包装件数（大包装个数）
     */
     ...
     * @return 申报价格
     */
    public java.math.BigDecimal getDeclarePrice() {
        return declarePrice;
    }
     ...
     * <p>申报价格</p>
     *
     * @param declarePrice 申报价格
     */
    public void setDeclarePrice(java.math.BigDecimal declarePrice) {
     ...
     * <p>申报价格对应价盘通道</p>
     *
     * @param priceWayName 申报价格对应价盘通道
     */
    public void setPriceWayName(String priceWayName) {
        this.priceWayName = priceWayName;
    }
    /**
     * <p>版本号</p>
     *
