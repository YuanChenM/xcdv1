...
public class SL24110103Controller extends BaseUploadController {
    ...
    public void update(MultipartFile file,Long certSeq,String[] certItemSeq,String[] certItemValue,String certId,HttpServletRequest request,HttpServletResponse response) throws IOException {
    ...
    public void delete(Long certSeq,String[] certItemSeq,String[] certItemValue,String certId,HttpServletRequest request,HttpServletResponse response) throws IOException {
        Long slEpId = (Long)request.getSession().getAttribute("jsp_epId2");
        ArrayList<SL24110302_1Bean> lists=new ArrayList<SL24110302_1Bean>();
