...
import com.msk.sl.logic.SL24110107Logic;
...
public class SL24110107Controller extends BaseUploadController{
    ...
    public void update(MultipartFile brand,MultipartFile brandpac,MultipartFile brandHonor,HttpServletResponse response,SL2411030033Bean sL2411030033Bean,HttpServletRequest request) throws IOException {
    ...
    public void deleteBrand(HttpServletResponse response,SL2411030033Bean sl2411030033Bean,HttpServletRequest request) throws IOException {
        String slCode = request.getSession().getAttribute("jsp_slCode").toString();
    ...
    public void update2(SL2411030073Bean sl2411030073Bean,HttpServletResponse response) throws IOException {
        String slCode = request.getSession().getAttribute("jsp_slCode").toString();
    ...
    public void deleteAgentPdBrand(SL2411030073Bean sl2411030073Bean,HttpServletResponse response) throws IOException {
        String slCode = request.getSession().getAttribute("jsp_slCode").toString();
        sl2411030073Bean.setSlCode(slCode);
