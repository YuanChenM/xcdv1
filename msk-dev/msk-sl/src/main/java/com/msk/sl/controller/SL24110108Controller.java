...
public class SL24110108Controller extends BaseUploadController{
    ...
    public void update(MultipartFile file,HttpServletResponse response,SL24110306Bean sL24110306Bean) throws IOException {
        ...
        if("5".equals(sL24110306Bean.getMemberDuties())){
            ...
            sL24110306Bean.setUpdId(super.getLoginUser().getUpdId());
            /**更新成员信息*/
            ...
            if (file.getSize() == 0) {
                ...
                //图片上传到ftp里面
                String uploadFilePath= BusinessConst.SLPath.SERVICEIMAGEPATH+"/"+BusinessConst.SLPath.SLIMAGEPATH+"/"+sL24110306Bean.getEpId()+"/";
