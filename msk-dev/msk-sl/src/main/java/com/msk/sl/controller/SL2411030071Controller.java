...
import com.msk.sl.logic.SL241103007Logic;
...
public class SL2411030071Controller extends BaseUploadController{
    ...
    @Transactional
    public void insert(MultipartFile brandCertFile,MultipartFile file,MultipartFile brandFile,HttpServletResponse response,SL2411030073Bean sL2411030073Bean,SL2411030033Bean sL2411030033Bean,HttpServletRequest request) throws IOException {
        ...
        if (s.size()>0) {
            ...
            sL2411030033Bean.setVer(NumberConst.IntDef.INT_ONE);
            sL2411030033Bean.setDelFlg("0");
    ...
    public void insert2(HttpServletResponse response,SL2411030073Bean sL2411030073Bean,HttpServletRequest request) throws IOException {
        //卖家产品品牌表插入
        Long epId = (Long)request.getSession().getAttribute("jsp_epId2");
