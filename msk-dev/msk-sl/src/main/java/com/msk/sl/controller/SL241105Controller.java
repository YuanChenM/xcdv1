...
public class SL241105Controller extends BaseController {
    ...
    public String featureInit(@PathVariable("showType") String showType, Model model, BaseParam baseparam) {
        ...
        if (isDebug) {
            model.addAttribute("slCode", "264050107");
            model.addAttribute("classesCode", "01");
            model.addAttribute("breedCode", "01");
    ...
    PageResult<SL241105Bean> search(@PathVariable("isFeature") String isFeature,
        ...
        DbUtils.buildLikeCondition(param, "prodEpName", DbUtils.LikeMode.FRONT);
        ...
        if (isDebug) {
            return sL241105Logic.getSL241105BeanInfo();
        } else {
            param.setFilter("pdFeatureCode", isFeature);
            return sL241105Logic.findPage(param, SL241105Bean.class);
        }
    }
    ...
    String verifyQly(@PathVariable("type") String type, SL241105Bean param, Model model) {
        ...
        List<SL241105Bean> beans = sL241105Logic.findPageList(basePageParam, SL241105Bean.class);
        basePageParam.getFilterMap().put("pdFeatureCode", "00");
        List<SL241105Bean> bean2s = sL241105Logic.findPageList(basePageParam, SL241105Bean.class);
...
//                    }
                    if (slTncGradeCode == 1 || slTncGradeCode == 2 || slTncGradeCode == 3) {
                        ...
                        //卖家信息
                        List<SL241101Bean> sl241101BeansList = sl241101Logic.findPageList(pageParam, SL241101Bean.class);
                        //销售平台
                        ...
                        if ("1".equals(bean.getDistFlg())) {
                            ...
                            if (null == isl231191Result) {
                                ...
                                List<SL241132Bean> sl241132Beans = sl241132Logic.findPageList(pageParam, SL241132Bean.class);
                                //货号累加
