...
public class ISL231127RsController extends BaseRsController{
     ...
     * @return rs
     */
    @RequestMapping(value = "/api/v1/sl/slInfo/slEpCert/new",method = RequestMethod.POST,produces = {MediaType.APPLICATION_JSON_VALUE})
    @Validator(validatorClass = "com.msk.sl.validator.ISL231127Validator")
