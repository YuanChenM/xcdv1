...
<%@include file="/comm/taglib.jsp"%>
	<div id="accordionSL24110310" class="group-accordion" collapsible="true" active="false">
		<h3>
			<label>生产商列表</label>
		</h3>
			...
			<table id="SL24110310_grid">
				<thead>
					<tr>
						...
						<th coltype="action" width="8%">授权证书 <input type="button"
							hidden="true" id="editBtn1" value="授权证书" coltype="search"
							title="授权证书" class="h-button" />
						</th>
						<th coltype="action" width="8%">企业资质 <input type="button"
...
<script src="${ctx}/js/sl/SL24110310.js"></script>
