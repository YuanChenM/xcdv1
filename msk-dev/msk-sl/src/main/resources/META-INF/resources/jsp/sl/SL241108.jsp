...
<div class="page-content list-page">
    ...
    <c:if test="${examineStatus eq '1'}">
        <div class="group-accordion" collapsible="false" active="false">
            ...
            <table style="width: 100%">   
                <tr>
	                <td width="10%"><msk:button buttonValue="A1级" buttonId="SL241108.Examine1"/></td>
	                <td width="10%"><msk:button buttonValue="A2级" buttonId="SL241108.Examine2"/></td>
	                <td width="10%"><msk:button buttonValue="A3级" buttonId="SL241108.Examine3"/></td>
	                <td width="10%"><msk:button buttonValue="不通过" buttonId="SL241108.Examine4"/></td>
    ...
    <c:if test="${examineStatus eq '2'}">
        <div class="group-accordion" collapsible="false" active="false">
            ...
            <table style="width: 100%">   
                <tr>
	                <td width="10%"><msk:button buttonValue="正确" buttonId="SL241108.Confirm"/></td>
	                <td width="10%"></td>
	                <td width="10%"><msk:button buttonValue="不正确" buttonId="SL241108.UnConfirm"/></td>
...
<script type="text/javascript" src="${ctx}/js/sl/SL241108.js"></script>
