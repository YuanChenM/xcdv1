            ...
            <div>
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td align="right"><msk:button buttonType="button" buttonValue="添加" buttonId="PD141116.ADD"/></td>
                        <td align="right"><msk:button buttonType="button" buttonValue="新品种/特征/净重/包装列表" buttonId="PD141116.LIST"/></td>
                        <td align="right"><msk:button buttonType="button" buttonValue="新品种/特征/净重/包装申请" buttonId="PD141116.NEW"/></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div>
                ...
                <table id="SL241116_list_grid">
                    ...
                    <tr>
                        ...
                        <th coltype="text" width="10%" name="distFlg">参与神农客分销</th>
...
<script src="${ctx}/js/sl/SL241116.js"></script>
