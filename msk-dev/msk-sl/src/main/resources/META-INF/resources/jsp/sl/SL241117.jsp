            ...
            <table class="tree dataTable no-footer" style="width: 100%">
                ...
                <c:forEach items="${sL241117Beans}" var="pdTncTd" varStatus="j">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="contentArray" rows="3" id="input_${j.index+1}" <c:if test="${pdTncTd.agreeFlg != '0'}">readonly="readonly"</c:if>>${pdTncTd.stdVal}</textarea>
                        </td>
                    </tr>
                </c:forEach>
            </table>
...
<script type="text/javascript" src="${ctx}/js/sl/SL241117.js"></script>