...
var SL241104 = {
    ...
    checkResultChange: function (tag, trId, index) {
        var $value = $(tag).val();
        if ($value == "2") {
            $.alertMessage.info("<center>不正确原因:<input id='reason'></center>", function () {
    ...
    checkChange: function (tag, trId, index) {
        var $value = $(tag).val();
        if ($value == "4") {
            $.alertMessage.info("<center>不通过原因:<textarea rows='3' cols='20' id='reason'></textarea></center>", function () {
                var $reason = $("#reason").val();
    ...
    rowCallback: function (tr, data) {
        ...
        if (data.slTncGradeCode == 1) {
            $td.html("<select name='check' onchange='SL241104.checkChange(this,\"" + $trId + "\",7)' id='check" + data.slPdId + "'><option value=''></option><option value='1' selected='selected'>A1</option><option value='2'>A2</option><option value='3'>A3</option><option value='4'>不通过</option></select>");
        } else if (data.slTncGradeCode == 2) {
            $td.html("<select name='check' onchange='SL241104.checkChange(this,\"" + $trId + "\",7)' id='check" + data.slPdId + "'><option value=''></option><option value='1'>A1</option><option value='2' selected='selected'>A2</option><option value='3'>A3</option><option value='4'>不通过</option></select>");
        } else if (data.slTncGradeCode == 3) {
            $td.html("<select name='check' onchange='SL241104.checkChange(this,\"" + $trId + "\",7)' id='check" + data.slPdId + "'><option value=''></option><option value='1'>A1</option><option value='2'>A2</option><option value='3' selected='selected'>A3</option><option value='4'>不通过</option></select>");
        }else if (data.slTncGradeCode == 4) {
            $td.html("<select name='check' onchange='SL241104.checkChange(this,\"" + $trId + "\",7)' id='check" + data.slPdId + "'><option value=''></option><option value='1'>A1</option><option value='2'>A2</option><option value='3'>A3</option><option value='4' selected='selected'>不通过</option></select>");
        }
        //else if (data.slTncGradeCode == 4) {
        //    $td.html("<select name='check' onchange='SL241104.checkChange(this,\"" + $trId + "\",6)' id='check" + data.slPdId + "'><option value=''></option><option value='1'>A1</option><option value='2'>A2</option><option value='3'>A3</option><option value='4' selected='selected'>论证中</option><option value='5'>禁止准入</option><option value='6'>已准入</option></select>");
        //}else if (data.slTncGradeCode == 5) {
        //    $td.html("<select name='check' onchange='SL241104.checkChange(this,\"" + $trId + "\",6)' id='check" + data.slPdId + "'><option value=''></option><option value='1'>A1</option><option value='2'>A2</option><option value='3'>A3</option><option value='4'>论证中</option><option value='5' selected='selected'>禁止准入</option><option value='6'>已准入</option></select>");
        //}else if (data.slTncGradeCode == 6) {
        //    $td.html("<select name='check' onchange='SL241104.checkChange(this,\"" + $trId + "\",6)' id='check" + data.slPdId + "'><option value=''></option><option value='1'>A1</option><option value='2'>A2</option><option value='3'>A3</option><option value='4'>论证中</option><option value='5'>禁止准入</option><option value='6' selected='selected'>已准入</option></select>");
        //}
        else{
        ...
        if (data.tncMonitorResult == 1) {
            $td.html("<select name='checkResult' id='checkResult" + data.slPdId + "'><option></option><option value='1' selected='selected'>正确</option><option value='2'>不正确</option><option value='3'>未审核</option></select>");
        } else if (data.tncMonitorResult == 2) {
            $td.html("<select name='checkResult' id='checkResult" + data.slPdId + "'><option></option><option value='1'>正确</option><option value='2' selected='selected'>不正确</option><option value='3'>未审核</option></select>");
        } else if (data.tncMonitorResult == 3) {
            $td.html("<select name='checkResult' id='checkResult" + data.slPdId + "'><option></option><option value='1'>正确</option><option value='2'>不正确</option><option value='3' selected='selected'>未审核</option></select>");
        } else {
            $td.html("<select name='checkResult' id='checkResult" + data.slPdId + "'><option></option><option value='1'>正确</option><option value='2'>不正确</option><option value='3'>未审核</option></select>");
        }
