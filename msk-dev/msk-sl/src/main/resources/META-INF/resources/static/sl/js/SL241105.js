...
var SL241105 = {
    ...
    checkChange: function (tag, trId, index) {
        var $value = $(tag).val();
        if ($value == "3") {
            $.alertMessage.info("<center>不合格原因:<textarea rows='3' cols='20' id='reason'></textarea>", function () {
                var $reason = $("#reason").val();
    ...
    rowCallback: function (tr, data) {
        ...
        $(tr).attr("id", $trId);
        //$(tr).attr("trIndex",SL241105.trIndex);
        var $td = $(tr).children('td').eq(0);
        $td.attr("trIndex", SL241105.trIndex);
        //$td.html("");
        ...
        if (data.slQltGradeCode == 2) {
            $td.html("<select name='check' onchange='SL241105.checkChange(this,\"" + $trId + "\",7)' id='check" + data.slPdId + "'><option value=''></option><option value='2' selected='selected'>合格</option><option value='3'>不合格</option></select>");
        } else if (data.slQltGradeCode == 3) {
            $td.html("<select name='check' onchange='SL241105.checkChange(this,\"" + $trId + "\",7)' id='check" + data.slPdId + "'><option value=''></option><option value='2'>合格</option><option value='3' selected='selected'>不合格</option></select>");
        }
        //else if (data.slQltGradeCode == 4) {
        //    $td.html("<select name='check' onchange='SL241105.checkChange(this,\"" + $trId + "\",6)' id='check" + data.slPdId + "'><option value=''></option><option value='2'>合格</option><option value='3' selected='selected'>不合格</option><option value='4' selected='selected'>论证中</option><option value='5'>禁止准入</option><option value='6'>已准入</option></select>");
        //}else if (data.slQltGradeCode == 5) {
        //    $td.html("<select name='check' onchange='SL241105.checkChange(this,\"" + $trId + "\",6)' id='check" + data.slPdId + "'><option value=''></option><option value='2'>合格</option><option value='3' selected='selected'>不合格</option><option value='4'>论证中</option><option value='5' selected='selected'>禁止准入</option><option value='6'>已准入</option></select>");
        //}else if (data.slQltGradeCode == 6) {
        //    $td.html("<select name='check' onchange='SL241105.checkChange(this,\"" + $trId + "\",6)' id='check" + data.slPdId + "'><option value=''></option><option value='2'>合格</option><option value='3' selected='selected'>不合格</option><option value='4'>论证中</option><option value='5'>禁止准入</option><option value='6' selected='selected'>已准入</option></select>");
        //}
        else{
            $td.html("<select name='check' onchange='SL241105.checkChange(this,\"" + $trId + "\",7)' id='check" + data.slPdId + "'><option value='' selected='selected'></option><option value='2'>合格</option><option value='3'>不合格</option></select>");
        }
        ...
        SL241105.detailRows[SL241105.trIndex] = data;
        SL241105.trIndex++;
    }
}
