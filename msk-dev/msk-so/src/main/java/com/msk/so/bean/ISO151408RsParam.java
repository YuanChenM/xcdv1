 ...
 * @author sjj
 */
public class ISO151408RsParam extends BaseParam{
    // 订单ID
    ...
    // 发货明细
    private List<ISO151408RsShipListParam> shipList;
    ...
    public List<ISO151408RsShipListParam> getShipList() {
        return shipList;
    }

    public void setShipList(List<ISO151408RsShipListParam> shipList) {
