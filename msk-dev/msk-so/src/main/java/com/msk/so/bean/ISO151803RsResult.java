 ...
 *
 */
public class ISO151803RsResult extends BaseEntity {
   ...
   private  List<ISO151803Ship>shipList;
    ...
    public List<ISO151803Ship> getShipList() {
        return shipList;
    }

    public void setShipList(List<ISO151803Ship> shipList) {
