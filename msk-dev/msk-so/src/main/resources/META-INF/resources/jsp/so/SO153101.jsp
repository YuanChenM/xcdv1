...
<navigation:header title="买家-交易记录查询" backTitleArray="" backUrlArray="${ctx}"></navigation:header>
<div class="page-content list-page">
    <form action="${ctx}/SO153101/search" id="SO153101Form" method="post">
        <div class="group-accordion" collapsible="true" active="true">
            ...
            <table WIDTH="100%">
                ...
                <tr>
                    ...
                    <td/>
                    <td align="right">
                        <msk:button buttonValue="查询" buttonId="SO153101.SEARCH" buttonType="button"/>
                    </td>
                </tr>
            </table>
        </div>
        <div>
            <table id="SO153101_list_grid" WIDTH="100%" border="1">
                <thead>
                <tr>
...
<script src="${ctx}/js/so/SO153101.js"></script>
