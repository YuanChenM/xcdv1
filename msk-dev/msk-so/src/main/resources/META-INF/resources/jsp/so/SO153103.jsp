    ...
    <div>
        <div>
            <table class="tree dataTable no-footer" style="widtd: 100%">
                ...
                <tr align="center">
                    <td coltype="text" height="50px" name="">${sO153103Bean.type}</td>
                    <td coltype="text" height="50px" name="">${sO153103Bean.name}</td>
                    <td coltype="text" height="50px" name="">${sO153103Bean.price}</td>
                    <td coltype="text" height="50px" name="">${sO153103Bean.discount}</td>
                    <td coltype="text" height="50px" name="">${sO153103Bean.coupon}</td>
                    <td coltype="text" height="50px" name="">${sO153103Bean.serviceCharge}</td>
                    <td coltype="text" height="50px" name="">${sO153103Bean.total}</td>
                </tr>
            </table>
        </div>
    </div>
