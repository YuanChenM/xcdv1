...
<navigation:header title="买手-交易记录查询" backTitleArray="" backUrlArray="${ctx}"></navigation:header>
<div class="page-content list-page">
    <form action="${ctx}/SO153301/search" id="SO153301Form" method="post">
        <div class="group-accordion" collapsible="true" active="true">
            ...
            <table WIDTH="100%">
                ...
                <tr>
                    ...
                    <td/>
                    <td align="right">
                        <msk:button buttonValue="查询" buttonId="SO153301.SEARCH" buttonType="button"/>
                    </td>
                </tr>
            </table>
        </div>
        <div>
            <table id="SO153301_list_grid" WIDTH="100%">
                <thead>
                <tr>
                    <th coltype="text" width="15%" id="tranTime" name="tranTime">交易时间${remark}</th>
...
<script src="${ctx}/js/so/SO153301.js"></script>
