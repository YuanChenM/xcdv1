...
<div class="page-content list-page">
    <form action="${ctx}/SP171130/save" id="SP171130Form" method="post">
        ...
        <div class="group-accordion" collapsible="" active="false">
            ...
            <table WIDTH="100%">
                ...
                <tr>
                    ...
                    <td width="55%" align="left">${sp171129Param.pdName} ${sp171129Param.machining} ${sp171129Param.feacherName} <c:if test="${sp171129Param.weightVal != 0}" >${sp171129Param.weightVal}kg</c:if> ${SP171130Param.pdLevel}</td>
                    <td width="20%"><td/>
                </tr>
            </table>
        </div>
            ...
            <table class="dataTable no-footer" id="" style="width: 100%">
                <thead>
                    <tr style="background:#DBDBDB">
                        ...
                        <th align="center" coltype="text" width="8%" name="" rowspan="2">0000010报价</th>
                        <th align="center" coltype="text" width="8%" name="" rowspan="2">0000020报价</th>
                        <th align="center" coltype="text" width="8%" name="" rowspan="2">0000030报价</th>
                    </tr>
                    <tr style="background:#DBDBDB">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach items="${sp171129BeanList}" var="item" varStatus="status">
                                <tr>
                                    <td align="center" id="orderLevelCodeTd${status.index}"  style="background-color: #DBDBDB">
                                        ...
                                        <input type="text" id="orderLevelName${status.index}" name="sp171129Beans[${status.index}].orderLevelName" style="border-style: solid; border-width: 0;width: 100%;background-color: #DBDBDB"  value="${item.orderLevelName}" readonly="readonly">
                                    </td>
                                    <td  style="background-color: #DBDBDB">
                                        <input id="levelStandMin${status.index}" value="${item.levelStandMin}" style="border-style: solid; border-width: 0;width: 100%;background-color: #DBDBDB" name="sp171129Beans[${status.index}].levelStandMin"  maxlength="19" readonly="readonly">
                                    </td>
                                    <td style="background-color: #DBDBDB">
                                    ...
                                    <td  style="background-color: #DBDBDB">
                                        <input type="text" id="currentCoefficient${status.index}" name="sp171129Beans[${status.index}].currentCoefficient" style="border-style: solid; border-width: 0;width: 100%;background-color: #DBDBDB" value="${item.currentCoefficient}" readonly="readonly" maxlength="8">
                                    </td>
                                    <td style="background-color: #DBDBDB">
                                    ...
                                    <td id="priceOfKgTd"  style="background-color: #DBDBDB">
                                        <input type="text" id="priceOfKg${status.index}" name="sp171129Beans[${status.index}].priceOfKg" value="${item.priceOfKg}" style="border-style: solid; border-width: 0;width: 100%;background-color: #DBDBDB"  maxlength="7" readonly="readonly">
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:otherwise>
        ...
        <%--<msk:button buttonValue="返回" buttonId="SP171130.BACK" url="${ctx}/SP171130/init" buttonType="button"/>--%>
    </form>
</div>

<script src="${ctx}/js/sp/SP171130.js"></script>
