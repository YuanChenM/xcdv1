...
var SP171129 = {
	$List_Grid: '',
	formId: "SP171129Form",
	saveButtonId: "SP171129_SAVE",
	initDataGrid: function () {
		SP171129.bindSaveButton();
	},
	bindSaveButton: function () {
		$("#" + SP171129.saveButtonId).click(function () {
			var flag = true;
			$('#SP171129Tbody').find('tr').each(function () {
			...
			var $SP171129Form = $("#SP171129Form");
			var formData = $SP171129Form.serializeArray();//getFormData($("#SO151408Form"));
			$('#main-content').postUrl($("#SP171129Form").attr("action"),formData);
		});
	}
}
