...
namespace snkBarCode
{
    public class BarCode
    {
        ...
        private String s_ReadCode;
        public String ReadCode { get { return s_ReadCode; } set { s_ReadCode = value; } }
        ...
        private void GetViewText(Bitmap p_Bitmap, string p_ViewText)
        {
            ...
            //_StarY = p_Bitmap.Height - (int)_DrawSize.Height;
            //_Graphics.FillRectangle(Brushes.White, new Rectangle(0, _StarY, p_Bitmap.Width, (int)_DrawSize.Height));
            //_Graphics.DrawString(s_ReadCode, m_ValueFont, Brushes.Black, 0, _StarY);
        }
